...
public class DayDynamicLineChartFrament extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        view = inflater.inflate(R.layout.fragment_dynamic_linechart_day, container, false);
        initView();
    ...
    private void showFragment(){
        ...
        if(!fragments.get(currentIndex).isAdded()){
            transaction
                    ...
                    .add(R.id.fra_chart_workshop_day,fragments.get(currentIndex),""+currentIndex);  //第三个参数为添加当前的fragment时绑定一个tag
