...
public class MonTableFragment extends Fragment implements View.OnClickListener{
    private Button btn;
    private SmartTable<EnvironmentInfoMon.EnvironmentInfoListBean> table;
    ...
    List<EnvironmentInfoMon.EnvironmentInfoListBean> testData = new ArrayList<>();;
    private View view;
    ...
    public void initView(){
        ...
        table = (SmartTable<EnvironmentInfoMon.EnvironmentInfoListBean>) view.findViewById(R.id.table);
    ...
    public void getEnvironmentInfoList() {
        ...
        einfo.enqueue(new Callback<EnvironmentInfoMon>() {
            @Override
            public void onResponse(Call<EnvironmentInfoMon> call, Response<EnvironmentInfoMon> response) {
                ...
                for(int j=0;j<ef.getEnvironmentInfoList().size();j++){
                    ...
                    time = ef.getEnvironmentInfoList().get(j).getMonTime();
...
//                                       boolean isPm, String dayTime, boolean isEvent
    ...
    public void initTable(){
        ...
        timeColumn = new Column<>("日期", "monTime");
        ...
        Column<Boolean> column_wd = new Column<>("温度", "isTmp" , new TextImageDrawFormat<Boolean>(size,size, TextImageDrawFormat.RIGHT,10) {
            ...
            protected Context getContext() {
                return MonTableFragment.this.getContext();
            }
        ...
        final TableData<EnvironmentInfoMon.EnvironmentInfoListBean> tableData = new TableData<>("环境监测数据表格",testData,nameColumn,
        ...
        MultiLineBubbleTip<Column> tip = new MultiLineBubbleTip<Column>(this.getContext(),R.mipmap.round_rect,R.mipmap.triangle,fontStyle) {
            ...
            public String[] format(Column column, int position) {
                EnvironmentInfoMon.EnvironmentInfoListBean data = testData.get(position);
        ...
        table.setOnColumnClickListener(new OnColumnClickListener() {
            ...
            public void onClick(ColumnInfo columnInfo) {
                ...
                Toast.makeText(MonTableFragment.this.getContext(),"点击了"+columnInfo.column.getColumnName(),Toast.LENGTH_SHORT).show();
            }
        });
        ...
        ICellBackgroundFormat<CellInfo> backgroundFormat = new BaseCellBackgroundFormat<CellInfo>() {
            ...
            public int getBackGroundColor(CellInfo cellInfo) {
                if(cellInfo.row %2 == 0) {
                    return ContextCompat.getColor(MonTableFragment.this.getContext(), R.color.content_bg);
                }
        ...
        ICellBackgroundFormat<Integer> backgroundFormat2 = new BaseCellBackgroundFormat<Integer>() {
            ...
            public int getBackGroundColor(Integer position) {
                if(position%2 == 0){
                    return ContextCompat.getColor(MonTableFragment.this.getContext(),R.color.arc1);
                }
                return TableConfig.INVALID_COLOR;
            ...
            public int getTextColor(Integer position) {
                if(position%2 == 0) {
                    return ContextCompat.getColor(MonTableFragment.this.getContext(), R.color.white);
                }
                return TableConfig.INVALID_COLOR;
            }
        };
